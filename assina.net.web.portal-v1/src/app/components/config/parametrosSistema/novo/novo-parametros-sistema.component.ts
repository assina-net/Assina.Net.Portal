...
export class NovoParametroSistemaComponent extends NovoSistemaAtributoComponent {
  ...
  constructor(route: ActivatedRoute) {
    ...
    this.titulo = "Parâmetro do Sistema";
    this.navegacao = " > Config > Parâmetro Sistema > Editar";
